...
class EditCollectionDescriptionCommand {
    constructor(context) {
        this.context = context;
        context.subscriptions.push(vscode_1.commands.registerCommand('integrationWorkbench.editCollectionDescription', this.handle.bind(this)));
    }
    handle(reference) {
...
exports.default = EditCollectionDescriptionCommand;
//# sourceMappingURL=EditCollectionDescriptionCommand.js.map