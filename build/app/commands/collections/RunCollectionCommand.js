...
class RunCollectionCommand {
    constructor(context) {
        this.context = context;
        context.subscriptions.push(vscode_1.commands.registerCommand('integrationWorkbench.runCollection', this.handle.bind(this)));
    }
    handle(reference) {
...
exports.default = RunCollectionCommand;
//# sourceMappingURL=RunCollectionCommand.js.map