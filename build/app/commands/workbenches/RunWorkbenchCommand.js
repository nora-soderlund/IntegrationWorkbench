...
class RunWorkbenchCommand {
    constructor(context) {
        this.context = context;
        context.subscriptions.push(vscode_1.commands.registerCommand('integrationWorkbench.runWorkbench', this.handle.bind(this)));
    }
    handle(reference) {
...
exports.default = RunWorkbenchCommand;
//# sourceMappingURL=RunWorkbenchCommand.js.map