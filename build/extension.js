...
function activate(context) {
    ...
    const rootPath = vscode.workspace.workspaceFolders && vscode.workspace.workspaceFolders.length > 0
        ...
        : undefined;
    const workbenchesTreeDataProvider = new WorkbenchTreeDataProvider_1.default(context, rootPath);
    ...
    context.subscriptions.push(vscode.commands.registerCommand('integrationWorkbench.dev.createWorkbenches', () => {
        context.workspaceState.update("workbenches", workbenches_1.workbenches);
